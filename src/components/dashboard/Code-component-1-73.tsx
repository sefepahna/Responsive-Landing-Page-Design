  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-purple-500 to-orange-500 rounded-2xl p-6 text-white"
      >
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={performanceData}>
                  ...
                  <Bar dataKey="wrong" fill="#F59E0B" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="empty" fill="#EF4444" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
